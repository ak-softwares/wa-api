...
var WaAccount_1 = require("./WaAccount");
var UserSchema = new mongoose_1.Schema({
    ...
    company: { type: String },
    defaultWaAccountId: { type: mongoose_1.default.Schema.Types.ObjectId, ref: "WaAccount" },
    resetPasswordToken: String,
    waAccounts: { type: [WaAccount_1.WaAccountSchema], default: [] },
    apiToken: {
        type: String,
        unique: true,
        sparse: true,
...
UserSchema.methods.generateApiToken = function () {
    var rawToken = "wa_agent_".concat(crypto_2.default.randomBytes(32).toString("hex"));
    this.apiToken = rawToken;
    this.apiTokenHashed = (0, crypto_1.hmacHash)(rawToken);
