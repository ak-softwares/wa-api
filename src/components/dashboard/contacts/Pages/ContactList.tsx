...
import SelectedContactsMenu from "../menus/SelectedContactsMenu";
...
export default function ContactList() {
  ...
  const [editContact, setEditContact] = useState<ImportedContact | null>(null);
  ...
  const handleEditContact = (editContact: Contact) => {
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="p-5 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          />
          <ContactsMenu
            onSelectContacts={() => setIsSelectionMode(true)}
