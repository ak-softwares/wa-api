...
export default function ContactsMenu({ onSelectContacts, onDeleteAllContacts }: ContactsMenuProps) {
  ...
  const goToBroadcastPage = () => {
    setSelectedContactMenu("broadcast");
  };
  ...
  const topItems = [
    ...
    { icon: "/assets/icons/download.svg", label: "Import from Excel", action: goToExcelImportPage },
    { icon: "/assets/icons/google.svg", label: "Import from Google", action: handleGoogleImport },
