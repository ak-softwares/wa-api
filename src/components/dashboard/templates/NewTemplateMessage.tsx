  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row gap-6 p-6">
      ...
      <div className="flex-1 space-y-6">
        ...
        {/* Submit */}
        <Button onClick={saveTemplate} disabled={isSaving} className="w-full mt-4">
      ...
      <div className="w-full md:w-[360px]">
        <Card className="sticky top-6">
          ...
          <CardContent className="bg-[#e9f5ec] dark:bg-gray-700 rounded-lg p-4 space-y-3 m-4 min-h-[200px]">
            {renderPreview()}
          </CardContent>
        </Card>
      </div>
