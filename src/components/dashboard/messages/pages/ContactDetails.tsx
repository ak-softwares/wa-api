...
import ViewAllMembersPopup from "../../chats/dialogs/ViewAllMembersPopup";
...
export default function ContactDetails({ isOpen, onClose, isBlocked, onEditBroadcast, onBlockToggle, onDelete }: ContactDetailsProps) {
  ...
  return (
    <div className="w-100 bg-white dark:bg-[#161717] border-l flex flex-col h-full">
        ...
        {isBroadcast && (
          <div className="p-4 border-t">
            <div className="flex justify-between items-center mb-2">
              ...
              <Button variant={"link"} onClick={onEditBroadcast} >
                <Edit2 />
                Edit
              </Button>
            </div>
      ...
      contact={{ phones: [activeChat?.participants?.[0]?.number || ""] }}
      />
    </div>
  );
}