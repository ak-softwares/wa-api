...
export default function SignInPage() {
  ...
  const onGoogleSignIn = async () => {
    try {
      ...
      console.log("Google sign-in initiated, result:", result); 
      // // ✅ Fetch session after login
      //   const { data: session, status } = useSession();

      // if (!session?.user?.email) {
      //   toast.error("Google sign-in failed", { description: "No email returned" });
      //   return;
      // }

      // // ✅ Call your backend to check user existence
      // // await connectDB();
